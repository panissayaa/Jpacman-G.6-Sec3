...
public class Theme extends JFrame {
    ...
    public Theme(){
        ...
        theme1Button.setBounds(125, 180, 130, 205);
        theme2Button.setBounds(325, 180, 130, 205);
        theme3Button.setBounds(125, 400, 130, 205);
        theme4Button.setBounds(325, 400, 130, 205);
